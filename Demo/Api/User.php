...
class Api_User extends PhalApi_Api {
    ...
    public function getRules() {
        return array(
			...
			'modifyInfo' => array(
                'openId' => array('name' => 'openid', 'type' => 'string', 'require' => false, 'desc' => '用户微信ID'),
                'brandId' => array('name' => 'brand_id', 'type' => 'int', 'require' => false, 'desc' => '品牌id'),
                'userType' => array('name' => 'user_type', 'type' => 'int', 'min' => 1, 'require' => false, 'desc' => '用户类型， 1表示新注册，2表示完善资料'),
				...
				'province' => array('name' => 'province', 'type' => 'string', 'require' => false, 'desc' => '省'),
				'city' => array('name' => 'city', 'type' => 'string', 'require' => false, 'desc' => '市'),
				'area' => array('name' => 'area', 'type' => 'string', 'require' => false, 'desc' => '县区'),
				'detail' => array('name' => 'detail', 'type' => 'string', 'require' => false, 'desc' => '具体地址'),
				'birY' => array('name' => 'birthday_y', 'type' => 'string', 'require' => false, 'desc' => '出生年'),
				'birM' => array('name' => 'birthday_m', 'type' => 'string', 'require' => false, 'desc' => '出生月'),
				'birD' => array('name' => 'birthday_d', 'type' => 'string', 'require' => false, 'desc' => '出生日'),
				'tel' => array('name' => 'tel', 'type' => 'string', 'require' => false, 'desc' => '电话'),
				'profession' => array('name' => 'profession', 'type' => 'string', 'require' => false, 'desc' => '行业'),
				'occupation' => array('name' => 'occupation', 'type' => 'string', 'require' => false, 'desc' => '职业'),
				'hobby' => array('name' => 'hobby', 'type' => 'string', 'require' => false, 'desc' => '爱好'),
